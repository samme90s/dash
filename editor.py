    ...
    def __init__(self):
        ...
        self.binds = (
            ...
            Key((pygame.K_s, pygame.K_DOWN),
                ...
                lambda: self.dir.toggle_down()),
            Key(pygame.K_g,
                lambda: self.toggle_ongrid()),
            Key(pygame.K_t,
                lambda: self.tilemap.automap()),
            Key(pygame.K_o,
                lambda: self.tilemap.save('map.json')),
            Key(pygame.K_TAB,
                lambda: self.scroll_tile_type(1)),
            Mouse(1,
                  lambda: self.toggle_click(),
                  lambda: self.toggle_click()
                  ),
            Mouse(3,
                  lambda: self.toggle_r_click(),
                  lambda: self.toggle_r_click()),
            Mouse(4,
                  lambda: self.scroll_tile_var(1)),
            Mouse(5,
                  lambda: self.scroll_tile_var(-1)))
